    ...
    public static function get($identifier) {
        ...
        switch ($identifier) {
            ...
            case 'MSG_BUY_PRO_INLINE_ATT':
                return sprintf(__('<span class="rm_buy_pro_inline">View and Download <b>form attachments</b> at a single place by upgrading <a href="%s" target="blank">Click here</a></span>', 'custom-registration-form-builder-with-submission-manager'),'https://registrationmagic.com/comparison/');
