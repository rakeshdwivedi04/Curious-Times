            ...
            <div class="rm-support-col-wrap">
                ...
                <div class="rm-support-col">
                   ...
                   <div class="rm-support-col-row">
                    ...
                    <div class="rm-support-col-row">
                        <div class="rm-support-col-subhead"><a href="https://metagauss.kayako.com/Default/Tickets/Submit" target="_blank"><?php _e('Feature Request', 'custom-registration-form-builder-with-submission-manager'); ?></a></div>
                    ...
                    <div class="rm-support-col-row">
                        <div class="rm-support-col-subhead"><a href="https://metagauss.kayako.com/Default/Tickets/Submit" target="_blank"><?php _e('Support Ticket', 'custom-registration-form-builder-with-submission-manager'); ?></a></div>
