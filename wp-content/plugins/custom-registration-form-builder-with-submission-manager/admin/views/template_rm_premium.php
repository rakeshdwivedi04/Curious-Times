    ...
    <div class="rm_pr_content">
        ...
        <div class="rm_pr_row">
            <div class="rm_pr_block_left">
                ...
                <div class="rm_pr_row rm_pitch_action_button">
                    <a target="_blank" href="https://metagauss.kayako.com/Default/Tickets/Submit"><?php _e("Questions?",'custom-registration-form-builder-with-submission-manager'); ?></a><!--|<a  target="_blank" href="https://registrationmagic.com/comparison/">&nbsp; Standard vs Premium</a>-->
                </div>
            </div>
        ...
        <div class="rm_pr_feature_block">
            <div class="rm_pr_feature_box_title">
                <span><?php _e("Top 47 reasons to upgrade!",'custom-registration-form-builder-with-submission-manager'); ?></span>
            </div>
            <hr />
            <div class="rm_pr_row">
